...
- `llm_process_health` - Report gateway process health: async-job manager state, the resolved durable persistence configuration, and flight-recorder health on that configured engine.
