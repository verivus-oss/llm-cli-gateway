...
const DatabaseUrlSchema = z.string().url().refine(carriesPostgresDsnScheme, {
...
const PersistenceSchema = z
  .object({
    ...
    dsn: z
      .string()
      .refine(carriesPostgresDsnScheme, {
        message: "[persistence].dsn must start with postgresql:// or postgres://",
      })
      .optional(),
