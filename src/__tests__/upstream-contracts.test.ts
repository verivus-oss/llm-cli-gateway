...
describe("upstream CLI contracts", () => {
  ...
  it("declares subcommand metadata for all providers, and Vibe's current tree", () => {
...
`;
  ...
  describe("ACP upstream entrypoint contracts (track-acp-upstream-contracts)", () => {
    ...
    it("keeps agy on the watchlist with no ACP surface at agy 1.1.24", () => {
      ...
      // 1.1.12 -> 1.1.17 (2026-08-14), and 1.1.17 -> 1.1.24 (2026-09-03).
      // Re-probed at agy 1.1.24: still absent_watchlist, still no native
      ...
      expect(agy.targetVersion).toContain("1.1.24");
