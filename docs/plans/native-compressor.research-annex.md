...
- https://curiouslychase.com/posts/yaml-vs-json-for-llm-token-efficiency-the-minification-truth/ - In the article's worked example, pretty JSON uses 101 tokens, YAML 133, and minified JSON 41; the common "YAML saves tokens" comparison uses formatted rather than minified JSON.
