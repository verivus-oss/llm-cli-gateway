...
| Path                          | Role                                                                                                                                                        |
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `release-targets.md`          | Exact upstream CLI versions each gateway release was validated against. This is release evidence, not a dependency lock or minimum-supported-version claim. |
...
versions observed in the release validation environment. Treat those rows as
the concrete provider behavior baseline for agent guidance and support triage.
Do not describe a target/probed version as a minimum, maximum, pinned,
installed-for-users, or guaranteed-compatible version unless a separate
compatibility gate proves that claim.
